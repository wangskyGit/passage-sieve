...
DE_CKPT_PATH=/webdav/MyData/NQ/NQ/nq_fintinue.pkl
CE_CKPT_PATH=/webdav/MyData/NQ/NQ/checkpoint-reranker26000
Origin_Data_Dir=$OUT_DIR/temp/train_ce.json
Origin_Data_Dir_Dev=/webdav/MyData/NQ/NQ/dev_ce_0.json
...
do
    ...
    --train_qa_path=/webdav/MyData/NQ/NQ/nq-train.qa.csv \
    --test_qa_path=/webdav/MyData/NQ/NQ/nq-test.qa.csv \
    --dev_qa_path=/webdav/MyData/NQ/NQ/nq-dev.qa.csv \
    --passage_path=/webdav/MyData/NQ/psgs_w100.tsv \
    --max_steps=$MAX_STEPS \
