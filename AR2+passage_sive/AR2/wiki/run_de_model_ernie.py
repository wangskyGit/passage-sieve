...
from AR2.model.models import BiEncoderNllLoss, BiBertEncoder
import random
...
def train(args, model, tokenizer):
    ...
    ### change the format of the dataloader at first and train a sieve model, and then reconstruct a new train_dataloader with confidence hard negatives
